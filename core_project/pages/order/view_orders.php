<?php   
	 ...
	 if(isset($_GET["order_id"])){
		...
		$order_details_table=$db->query("select p.name,od.qty,od.price from order_master o,item p,order_details od where o.id=od.order_id and p.id=od.item_id and o.id='$order_id'");
